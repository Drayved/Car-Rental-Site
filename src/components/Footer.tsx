...
const Footer = () => {
    ...
    return(
        <div className=" absolute bottom-0 w-screen z-20 footer-container mt-48 pb-16 flex flex-wrap justify-between  pt-12 px-2 shadow-sm bg-white shadow-black mx-auto text-center">
