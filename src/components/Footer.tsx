...
const Footer = () => {
    ...
    return(
        <footer className="relative bottom-0  h-screen -mt-[47rem]">

            
            <div className=" absolute bottom-0 w-screen mt-32 z-10 pb-16 flex flex-wrap justify-between  pt-12 px-2 shadow-sm bg-white shadow-black mx-auto text-center">
                <div className="w-full md:w-[25%] mr-[-50px]  mb-12">
                ...
                <div className="w-full md:w-[25%] ] mb-12">
                ...
                <div className="w-[90%] mx-auto md:w-[25%]  mb-2 ">
